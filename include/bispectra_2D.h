...
struct params_B_los_integrand { const std::string &key; double l1; double l2; double l3; ClassEngine *class_obj; bool use_pk_nl; projection_kernel *q1; projection_kernel *q2; projection_kernel *q3;};
